  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#2563EB] via-[#4F46E5] to-[#7C3AED] relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-16 text-white">
          ...
          >
            <div className="mb-8">
              <h1 className="text-5xl font-bold mb-4 tracking-tight">ART5MATA</h1>
              <p className="text-2xl font-light opacity-90">Installment Management</p>
            </div>
            ...
            <motion.div
              ...
              className="w-64 h-64 mx-auto mb-8 bg-white/10 backdrop-blur-lg rounded-3xl flex items-center justify-center border border-white/20"
            >
              <svg className="w-32 h-32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M50 10L70 30H60V60H70L50 80L30 60H40V30H30L50 10Z" fill="white" opacity="0.9"/>
            ...
            <motion.p
              ...
              className="text-lg opacity-80 max-w-md mx-auto"
            >
              Simplifying funeral plan management with dignity and care for Filipino families
            </motion.p>
          </motion.div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 backdrop-blur-lg border border-gray-100">
            ...
            <form onSubmit={handleEmailLogin} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#2563EB] to-[#4F46E5] text-white py-3 px-4 rounded-lg hover:from-[#1e40af] hover:to-[#4338ca] transition font-medium shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
